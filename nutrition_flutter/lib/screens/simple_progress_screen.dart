...
class _SimpleProgressScreenState extends State<SimpleProgressScreen> {
  ...
  Widget _buildProgressCards() {
    ...
    // Only show goals for daily view (index 0)
    final showGoals = _selectedTimeRange == 0;

    return Column(
      children: [
        SimpleProgressCard(
          title: 'Calories',
          subtitle: '${_timeRanges[_selectedTimeRange]} intake${showGoals ? ' vs goal' : ''}',
          currentValue: _progressData!.calories.current,
          goalValue: showGoals ? _progressData!.calories.goal : 0.0,
          unit: ' cal',
        ...
        SimpleProgressCard(
          ...
          goalValue: showGoals ? (_progressData!.goals['exercise']?.toDouble() ?? 30.0) : 0.0,
          unit: ' min',
