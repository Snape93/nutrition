...
class _ProfessionalHomeScreenState extends State<ProfessionalHomeScreen> {
  ...
  Widget _buildCaloriesCard() {
    ...
    final isNegative = remainingCalories < 0;
    // For progress indicator: show full circle when exceeded
    final progress = baseGoal > 0
        ? (isNegative
            ? 1.0
            : ((baseGoal - foodCalories + exerciseCalories) / baseGoal)
                .clamp(0.0, 1.0))
        : 0.0;
                ...
                SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    ...
                    valueColor: AlwaysStoppedAnimation<Color>(
                      isNegative ? Colors.grey : _primaryColor,
                    ),
                  ),
                ),
                Column(
                  children: [
                    Text(
                      ...
                      style: AppDesignSystem.displayMedium.copyWith(
                        color: isNegative ? Colors.grey : _primaryColor,
