#!/usr/bin/env python3
"""
Simple database migration script to add created_at column
"""
...
def run_migration():
    ...
    try:
        if 'postgresql' in db_url or 'postgres' in db_url:
            ...
            print(f"ERROR: Unsupported database type in URL: {db_url}")
            return False
...
def migrate_postgresql(db_url):
    ...
    try:
        ...
        if cursor.fetchone():
            print("SUCCESS: created_at column already exists")
            return True
